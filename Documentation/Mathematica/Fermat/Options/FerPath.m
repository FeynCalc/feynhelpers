...
(*`FileNameJoin[{$FeynHelpersDirectory, "ExternalTools", "Fermat", "ferl6", "fer64"}]` and `FileNameJoin[{$FeynHelpersDirectory, "ExternalTools", "Fermat","ferm6", "fer64"}]` for Linux and macOS respectively.*)
