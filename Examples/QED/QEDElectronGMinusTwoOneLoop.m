...
(* ::Subsection:: *)
(*Load FeynCalc and FeynArts and FeynHelpers*)
...
(* ::Text:: *)
(*Evaluate the resulting Passarino-Veltman functions using PackageX.*)


ampVertex4=PaXEvaluate[ampVertex3,PaXImplicitPrefactor->1/(2Pi)^D]
...
ampVertex5=ampVertex4//ChangeDimension[#,4]&//ReplaceAll[#,D->4]&//Factor2
