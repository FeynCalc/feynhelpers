...
(* :Title: AsymptoticExpansion-prop1Lsunrisex1101xm1m2m2					*)
...
intRaw=SFAD[{{l1, 0}, {m1^2, 1}, 1}]*SFAD[{{l1 + l2 - l3, 0}, {0, 1}, 1}]*SFAD[{{l3, 0}, {m2^2, 1}, 1}]*SFAD[{{l2 + q, 0}, {m1^2, 1}, 1}]


kinematics={SPD[q]->m3^2}


{int,topo}=FCLoopFindTopologies[intRaw,{l1,l2,l3},FinalSubstitutions->kinematics,Head->Identity,Names->Function[x,prop1Lsunrisex1101xm1m2m2Asy]];
topo=First[topo]
id=topo[[1]]
...
asyOutput=AlphaRepExpand[{l1,l2,l3},propsAsy,{q^2->m3^2},{m3->x^0,m1->x^1,m2->x^1},Verbose->False]
...
momShifts1={l->l-q};
propsR1=ReplaceAll[{propsFC,propsAsy},momShifts1];
...
Put[{int->resultFinal,topo}/.prop1L1->prop1Lm11asy,FileNameJoin[{$FeynCalcDirectory,"Examples","MasterIntegrals","propXLMassive",ToString[id]<>".m"}]]
